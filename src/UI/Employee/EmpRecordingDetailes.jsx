...
const EmpRecordingDetailes = () => {
  ...
  const buttonClass = (section) =>
    `rounded-lg px-3 py-1  ${ 
      (section === 'JobRole' && showJobRole) ||
      (section === 'TestInfo' && showTestInfo) ||
      (section === 'Interview' && showInterview) 
      ? 'bg-black text-white ' : 'bg-gray-300 text-black font-semibold'
    }`;
  return (
    <div className="">
...
export default EmpRecordingDetailes;
