...
const EmpRescheduleInterviews = () => {
  ...
  return (
    ...
    <div className='bg-custom-dark-blue px-3 py-2 rounded-lg space-x-8' >
      <p  className='text-pink-400'>Rescheduled Interviews</p>
    </div>
    <div className='space-y-3'>
        {currentRows.map((val,i)=>{
            return(
                <div className='flex justify-around px-10 py-4 border border-gray-300 shadow-lg shadow-gray-200 items-center rounded-lg '>
                    ...
                    <div className=" w-[10%] text-purple-500 text-lg font-semibold"> Rescheduled</div>
                </div>
            )
        })}
    </div>
...
export default EmpRescheduleInterviews
