...
const EmpProfileSidebar = () => {
  return (
    ...
    <div className="ml-5 mt-16 xl:mt-26 ">
      ...
      Let’s Create your Company’s profile
      </p>
    </div>
    <div className="mt-6 2xl:mt-12 ">
      <div className="flex items-center">
        ...
        <div className="text-white ml-2">
          ...
          <p className="text-sm">
          Please upload your company’s legitimate information
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="text-white pl-2 ">
          <p className="text-lg">
          Schedule Interviews using TrueAI
          </p>
          <p className="text-sm">
          Enjoy the revolutionised Interviewing Experience with TrueAI
          </p>
        </div>
      </div>
    </div>
...
export default EmpProfileSidebar
