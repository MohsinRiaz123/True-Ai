...
import useEmpSignup from "../../Services/Onboard/Signup/useEmpSignup";

const EmpSignup = () => {
  const { fetchData, error, loading } = useEmpSignup();
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      await fetchData(values); // Trigger the API call
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className={`rounded-3xl border px-4 outline-none ${
