              ...
              <div className="flex-col w-[80%] px-3 py-3 space-y-1">
                ...
                <div className="font-semibold flex gap-10">
                  <div className="flex gap-2">
                    <p className="text-pink-400 font-semibold">Rescheduled Date :</p>{val.date}
                  </div>
                  <div className="flex gap-2">
                    <p className="text-pink-400 font-semibold">Rescheduled Time :</p>{val.time} pm (EST)
                  </div>
                </div>
